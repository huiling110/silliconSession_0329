    ...
    \begin{table}[htbp] %[h]
        ...
        \resizebox{0.8\textwidth}{!}{% 
            \begin{tabular}{|c | c |c|} 
             ...
             \hline
             HD (120um)  & \alert{16/19 }               & good agreement \\
             \hline
             LD (200um)&   \alert{12/12} & good agreement \\
             \hline
             LD (300um) &   \alert{14/14} & good agreement \\
             \hline
            \end{tabular}
        }
...
\begin{frame}{300 um, CV results: HPK and CERN (on DF)}
    \begin{figure}
        \includegraphics[width=.9\textwidth]{plots/CV_CERN_HPK_300um_cropped.png}    
    \end{figure}
...
\begin{frame}{Summary for CV results}
  \begin{itemize}
      ...
      \item CV grading passed before and after Dicing Frame Removal
...
\begin{frame}{Proto-A, 300 um, CV grading (all passed)}
  \includegraphics[width=.7\textwidth]{plots/CV_grading_300um.png}
\end{frame}
%\begin{frame}
