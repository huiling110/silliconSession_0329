...
\begin{frame}{Proto A sensors and their properties}
  \begin{itemize}
      ...
      \item 120 um:
      \begin{itemize} 
        \item 19 HD Sensors: 5 oxide type B, 8 oxide type C (3 common p-stop), 6 oxide type D
      \end{itemize}
      \item 200 um:
      \begin{itemize} 
        \item 12 LD Sensors: 2 oxide type A, 3 oxide type B, 5 oxide type C (3 common p-stop), 2 oxide type D
      \end{itemize}
      \item 300 um:
      \begin{itemize} 
        \item 12 LD Sensors: 2 oxide type A, 3 oxide type B, 4 oxide type C (common p-stop), 5 oxide type D
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{General Remarks}
  \begin{center}
    \begin{tabular}{ c c } 
    \includegraphics[width=.3\textwidth]{plots/Switch_Card.png} & \multirow{2}{3em}{
      \begin{itemize}
        % \scriptsize
