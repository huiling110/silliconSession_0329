...
\begin{frame}{Sensor List 120 um}
    \begin{columns}
      \column{.5\textwidth}
        \begin{figure}
            \includegraphics[width=.9\textwidth]{plots/PM8_description.png}
    ...
    \begin{table}[htbp] %[h]
        ...
        \resizebox{0.9\textwidth}{!}{% 
            \begin{tabular}{|l | c |c|c| c | c |c| |c } 
             \hline
             channel              & 1tau1l & 1tau2l & 2tauXL & 1tau1l & 2tau0l \\
             \hline
             expectecd signficance& 0.5944 & 0.4261 & 0.1517 & 0.02629& 0.009596 \\
             \hline
            \end{tabular}
        }
        \caption{Expeceted signficance of all channels}
        \end{table}    
\end{frame}
